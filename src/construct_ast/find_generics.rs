...
pub fn get_generic_names(pos: &mut usize, tokens: &[SolidToken], info: &mut Info) -> (Vec<String>, Vec<String>) {
...
pub fn get_generics(pos: &mut usize, tokens: &[SolidToken], index: usize, ast: &mut Vec<Ast>, info: &mut Info) -> (Vec<String>, Vec<String>) {
